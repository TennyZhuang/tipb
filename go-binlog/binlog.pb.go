...
func (MutationType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_binlog_6b55bcfd1e6a660b, []int{0}
}
...
func (BinlogType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_binlog_6b55bcfd1e6a660b, []int{1}
}
...
func (*Binlog) Descriptor() ([]byte, []int) {
	return fileDescriptor_binlog_6b55bcfd1e6a660b, []int{2}
}
...
func init() { proto.RegisterFile("binlog.proto", fileDescriptor_binlog_6b55bcfd1e6a660b) }

var fileDescriptor_binlog_6b55bcfd1e6a660b = []byte{
