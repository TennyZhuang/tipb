...
func (Expr_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expr_5caad3686d5538a7, []int{0, 0}
}
...
func (DocumentPathItem_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expr_5caad3686d5538a7, []int{2, 0}
}
...
type Expr struct {
	...
	Literal              *Datatypes.Scalar `protobuf:"bytes,4,opt,name=literal" json:"literal,omitempty"`
...
func (*Expr) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expr_5caad3686d5538a7, []int{0}
}
...
func (m *Expr) GetLiteral() *Datatypes.Scalar {
	if m != nil {
		return m.Literal
	}
	return nil
...
func (*Identifier) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expr_5caad3686d5538a7, []int{1}
}
...
func (*DocumentPathItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expr_5caad3686d5538a7, []int{2}
}
func (m *DocumentPathItem) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DocumentPathItem) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DocumentPathItem.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *DocumentPathItem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DocumentPathItem.Merge(dst, src)
}
func (m *DocumentPathItem) XXX_Size() int {
	return m.Size()
}
func (m *DocumentPathItem) XXX_DiscardUnknown() {
	xxx_messageInfo_DocumentPathItem.DiscardUnknown(m)
}

var xxx_messageInfo_DocumentPathItem proto.InternalMessageInfo
...
func (*ColumnIdentifier) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expr_5caad3686d5538a7, []int{3}
}
func (m *ColumnIdentifier) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ColumnIdentifier) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ColumnIdentifier.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *ColumnIdentifier) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ColumnIdentifier.Merge(dst, src)
}
func (m *ColumnIdentifier) XXX_Size() int {
	return m.Size()
}
func (m *ColumnIdentifier) XXX_DiscardUnknown() {
	xxx_messageInfo_ColumnIdentifier.DiscardUnknown(m)
}

var xxx_messageInfo_ColumnIdentifier proto.InternalMessageInfo
...
func (*FunctionCall) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expr_5caad3686d5538a7, []int{4}
}
...
func (dst *FunctionCall) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FunctionCall.Merge(dst, src)
}
...
func (*Operator) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expr_5caad3686d5538a7, []int{5}
}
...
func (*Object) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expr_5caad3686d5538a7, []int{6}
}
...
func (*Object_ObjectField) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expr_5caad3686d5538a7, []int{6, 0}
}
...
func (*Array) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expr_5caad3686d5538a7, []int{7}
}
...
func init() {
	proto.RegisterFile("github.com/pingcap/tipb/go-mysqlx/Expr/mysqlx_expr.proto", fileDescriptor_mysqlx_expr_5caad3686d5538a7)
}

var fileDescriptor_mysqlx_expr_5caad3686d5538a7 = []byte{
