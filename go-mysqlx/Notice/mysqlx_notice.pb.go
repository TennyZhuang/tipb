...
func (Frame_Scope) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_ee21014cdc6fd3a0, []int{0, 0}
}
...
func (Warning_Level) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_ee21014cdc6fd3a0, []int{1, 0}
}
...
func (SessionStateChanged_Parameter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_ee21014cdc6fd3a0, []int{3, 0}
}
...
func (*Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_ee21014cdc6fd3a0, []int{0}
}
...
func (*Warning) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_ee21014cdc6fd3a0, []int{1}
}
...
type SessionVariableChanged struct {
	...
	Value                *Datatypes.Scalar `protobuf:"bytes,2,opt,name=value" json:"value,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (*SessionVariableChanged) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_ee21014cdc6fd3a0, []int{2}
}
...
func (m *SessionVariableChanged) GetValue() *Datatypes.Scalar {
	if m != nil {
		return m.Value
	}
	return nil
...
func (*SessionStateChanged) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_ee21014cdc6fd3a0, []int{3}
}
...
func (m *SessionStateChanged) GetValue() *Datatypes.Scalar {
	if m != nil {
		return m.Value
	}
	return nil
...
func init() {
	proto.RegisterFile("github.com/pingcap/tipb/go-mysqlx/Notice/mysqlx_notice.proto", fileDescriptor_mysqlx_notice_ee21014cdc6fd3a0)
}

var fileDescriptor_mysqlx_notice_ee21014cdc6fd3a0 = []byte{
