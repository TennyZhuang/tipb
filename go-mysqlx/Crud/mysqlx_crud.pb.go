...
import (
	...
	Datatypes "github.com/pingcap/tipb/go-mysqlx/Datatypes"

	Expr "github.com/pingcap/tipb/go-mysqlx/Expr"
...
func (DataModel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{0}
}
...
func (ViewAlgorithm) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{1}
}
...
func (ViewSqlSecurity) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{2}
}
...
func (ViewCheckOption) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{3}
}
...
func (Order_Direction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{4, 0}
}
...
func (UpdateOperation_UpdateType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{5, 0}
}
...
type Column struct {
	...
	DocumentPath         []*Expr.DocumentPathItem `protobuf:"bytes,3,rep,name=document_path,json=documentPath" json:"document_path,omitempty"`
...
func (m *Column) GetDocumentPath() []*Expr.DocumentPathItem {
	if m != nil {
...
type Projection struct {
	Source               *Expr.Expr `protobuf:"bytes,1,req,name=source" json:"source,omitempty"`
	Alias                *string    `protobuf:"bytes,2,opt,name=alias" json:"alias,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
...
func (m *Projection) GetSource() *Expr.Expr {
	if m != nil {
		return m.Source
	}
	return nil
...
// sort order
type Order struct {
	Expr                 *Expr.Expr       `protobuf:"bytes,1,req,name=expr" json:"expr,omitempty"`
...
func (*Order) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{4}
}
...
func (m *Order) GetExpr() *Expr.Expr {
	if m != nil {
		return m.Expr
	}
	return nil
...
type UpdateOperation struct {
	Source               *Expr.ColumnIdentifier      `protobuf:"bytes,1,req,name=source" json:"source,omitempty"`
	...
	Value                *Expr.Expr                  `protobuf:"bytes,3,opt,name=value" json:"value,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (*UpdateOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{5}
}
...
func (m *UpdateOperation) GetSource() *Expr.ColumnIdentifier {
	if m != nil {
		return m.Source
	}
	return nil
...
func (m *UpdateOperation) GetValue() *Expr.Expr {
	if m != nil {
		return m.Value
	}
	return nil
...
type Find struct {
	...
	Criteria             *Expr.Expr          `protobuf:"bytes,5,opt,name=criteria" json:"criteria,omitempty"`
	Args                 []*Datatypes.Scalar `protobuf:"bytes,11,rep,name=args" json:"args,omitempty"`
	...
	Grouping             []*Expr.Expr        `protobuf:"bytes,8,rep,name=grouping" json:"grouping,omitempty"`
	GroupingCriteria     *Expr.Expr          `protobuf:"bytes,9,opt,name=grouping_criteria,json=groupingCriteria" json:"grouping_criteria,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (*Find) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{6}
}
...
func (m *Find) GetCriteria() *Expr.Expr {
	if m != nil {
		return m.Criteria
	}
	return nil
...
func (m *Find) GetArgs() []*Datatypes.Scalar {
	if m != nil {
		return m.Args
	}
	return nil
...
func (m *Find) GetGrouping() []*Expr.Expr {
	if m != nil {
		return m.Grouping
	}
	return nil
...
func (m *Find) GetGroupingCriteria() *Expr.Expr {
	if m != nil {
...
type Insert struct {
	...
	Args                 []*Datatypes.Scalar `protobuf:"bytes,5,rep,name=args" json:"args,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (*Insert) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{7}
}
...
func (m *Insert) GetArgs() []*Datatypes.Scalar {
	if m != nil {
		return m.Args
	}
	return nil
...
type Insert_TypedRow struct {
	Field                []*Expr.Expr `protobuf:"bytes,1,rep,name=field" json:"field,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (*Insert_TypedRow) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{7, 0}
}
...
func (m *Insert_TypedRow) GetField() []*Expr.Expr {
	if m != nil {
		return m.Field
	}
	return nil
...
type Update struct {
	Collection           *Collection         `protobuf:"bytes,2,req,name=collection" json:"collection,omitempty"`
	DataModel            *DataModel          `protobuf:"varint,3,opt,name=data_model,json=dataModel,enum=Mysqlx.Crud.DataModel" json:"data_model,omitempty"`
	Criteria             *Expr.Expr          `protobuf:"bytes,4,opt,name=criteria" json:"criteria,omitempty"`
	Args                 []*Datatypes.Scalar `protobuf:"bytes,8,rep,name=args" json:"args,omitempty"`
...
func (*Update) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{8}
}
...
func (m *Update) GetCriteria() *Expr.Expr {
	if m != nil {
		return m.Criteria
	}
	return nil
...
func (m *Update) GetArgs() []*Datatypes.Scalar {
	if m != nil {
		return m.Args
	}
	return nil
...
type Delete struct {
	Collection           *Collection         `protobuf:"bytes,1,req,name=collection" json:"collection,omitempty"`
	DataModel            *DataModel          `protobuf:"varint,2,opt,name=data_model,json=dataModel,enum=Mysqlx.Crud.DataModel" json:"data_model,omitempty"`
	Criteria             *Expr.Expr          `protobuf:"bytes,3,opt,name=criteria" json:"criteria,omitempty"`
	Args                 []*Datatypes.Scalar `protobuf:"bytes,6,rep,name=args" json:"args,omitempty"`
...
func (*Delete) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{9}
}
...
func (m *Delete) GetCriteria() *Expr.Expr {
	if m != nil {
		return m.Criteria
	}
	return nil
...
func (m *Delete) GetArgs() []*Datatypes.Scalar {
	if m != nil {
		return m.Args
	}
	return nil
...
func (*CreateView) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{10}
}
...
func (*ModifyView) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{11}
}
...
func (*DropView) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_crud_dbae54f418e49bc2, []int{12}
}
...
func (m *Column) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.DocumentPath = append(m.DocumentPath, &Expr.DocumentPathItem{})
...
func (m *UpdateOperation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Source == nil {
				m.Source = &Expr.ColumnIdentifier{}
			}
			if err := m.Source.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *Find) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.Grouping = append(m.Grouping, &Expr.Expr{})
		...
		case 11:
			...
			m.Args = append(m.Args, &Datatypes.Scalar{})
...
func (m *Insert_TypedRow) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Field = append(m.Field, &Expr.Expr{})
...
func init() {
	proto.RegisterFile("github.com/pingcap/tipb/go-mysqlx/Crud/mysqlx_crud.proto", fileDescriptor_mysqlx_crud_dbae54f418e49bc2)
}

var fileDescriptor_mysqlx_crud_dbae54f418e49bc2 = []byte{
