...
type StmtExecute struct {
	...
	Args                 []*Datatypes.Any `protobuf:"bytes,2,rep,name=args" json:"args,omitempty"`
...
func (*StmtExecute) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_sql_1c5d8e585e1cc3e7, []int{0}
}
func (m *StmtExecute) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StmtExecute) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StmtExecute.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *StmtExecute) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StmtExecute.Merge(dst, src)
}
func (m *StmtExecute) XXX_Size() int {
	return m.Size()
}
func (m *StmtExecute) XXX_DiscardUnknown() {
	xxx_messageInfo_StmtExecute.DiscardUnknown(m)
}

var xxx_messageInfo_StmtExecute proto.InternalMessageInfo
...
func (m *StmtExecute) GetArgs() []*Datatypes.Any {
	if m != nil {
		return m.Args
	}
	return nil
...
func (*StmtExecuteOk) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_sql_1c5d8e585e1cc3e7, []int{1}
}
func (m *StmtExecuteOk) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StmtExecuteOk) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StmtExecuteOk.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *StmtExecuteOk) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StmtExecuteOk.Merge(dst, src)
}
func (m *StmtExecuteOk) XXX_Size() int {
	return m.Size()
}
func (m *StmtExecuteOk) XXX_DiscardUnknown() {
	xxx_messageInfo_StmtExecuteOk.DiscardUnknown(m)
}

var xxx_messageInfo_StmtExecuteOk proto.InternalMessageInfo
...
func (m *StmtExecute) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Args = append(m.Args, &Datatypes.Any{})
...
func init() {
	proto.RegisterFile("github.com/pingcap/tipb/go-mysqlx/Sql/mysqlx_sql.proto", fileDescriptor_mysqlx_sql_1c5d8e585e1cc3e7)
}

var fileDescriptor_mysqlx_sql_1c5d8e585e1cc3e7 = []byte{
